...
public class EmployeeForHrService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/ktrivedi/AppData/Local/Temp/tempdir8546441456257568888.tmp/employee_for_hr_1.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EmployeeForHrService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/ktrivedi/AppData/Local/Temp/tempdir8546441456257568888.tmp/employee_for_hr_1.wsdl");
        }
        WSDL_LOCATION = url;
    }
